...
const logos = [
  "https://brandeps.com/icon-download/A/Aws-icon-01.png",
  "https://images.g2crowd.com/uploads/product/image/social_landscape/social_landscape_611ad1bf7b895284e0851e42529395d7/render-render.png",
  "https://mediakind.com/wp-content/uploads/2022/07/microsoft-azure-big.png"
];

const logos2 = [
  "https://cdn4.iconfinder.com/data/icons/web-icons-22/48/webpage-512.png",
  "https://icons.iconarchive.com/icons/roundicons/100-free-solid/512/target-icon.png",
  "https://icons.veryicon.com/png/o/object/material-design-icons/lock-76.png"
];
    ...
    <div className="flex items-center justify-center min-h-52">
      <div className="relative flex items-center">
        <div className="bg-[#000] border border-white/30  rounded-2xl flex items-center justify-center w-14 h-14 p-4">
          <img src={logos2[0]} alt="Logo 1" className="filter invert brightness-0" />
        </div>
        ...
        <div className="relative bg-black border-2 border-white/70 rounded-2xl flex items-center justify-center w-16 h-16 p-4 overflow-hidden shadow-[0_0_15px_5px_#dbe0e2]">
          <img src={logos2[1]} alt="Logo 2" className="filter invert brightness-0" />
          <motion.div
        ...
        <div className="bg-black border border-white/30 rounded-2xl flex items-center justify-center w-14 h-14 p-4">
          <img src={logos2[2]} alt="Logo 3" className="filter invert brightness-0" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
        ...
        <div className="relative bg-black border-2 border-white/70 rounded-2xl flex items-center justify-center w-20 h-20 p-4 overflow-hidden shadow-[0_0_15px_5px_#dbe0e2]">
          <img src={logos[1]} alt="Logo 2" className="filter invert brightness-0 w-30" />
          <motion.div
            className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white to-transparent opacity-30"
            initial={{ x: '-100%' }}
            animate={{ x: '100%' }}
      ...
      <div className="text-left p-6 mt-4">
        <h1 className="text-white text-2xl font-bold mb-2">Cloud-Hosted Targets</h1>
        <p className="text-gray-400 text-lg">All challenges run in isolated Docker containers powered by AWS/Azure, secured and ephemeral.</p>
      </div>
    </div>
  );
};
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="mb-4 px-6 mt-6">
              <div className="flex justify-between items-center mb-6 pb-2">
                <h2 className="text-white/70 text-xl">CTF Solves Over Time</h2>
            ...
            <div className="text-left p-6 mt-4">
              <h1 className="text-white text-2xl font-bold mb-2">Player Progression</h1>
              <p className="text-white/70 text-lg">Track how users grow across real-world security domains like XSS, SSRF, and more.</p>
            </div>
          </div>
        </CardWithEffect>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-white text-2xl font-bold mb-2">Exploit Multiple Attack Surfaces</h1>
                <p className="text-white/70 text-lg">From Web and Mobile to Reverse Engineering, engage in diverse real-world exploit simulations.</p>
              </div>
            </div>
          </CardWithEffect>
          <CardWithEffect>
